...
button_styles := [Button_Theme]Button_Style {
	...
	.Number_Arrow = {
		...
		bg_color = {
			...
			.Engaged = COLOR_TRANSPARENT,
			.Engaged_Hover = COLOR_GREY_710,
			.Engaged_Active = COLOR_GREY_850,
			.Focus = COLOR_GREY_710,
			.Focus_Hover = COLOR_GREY_710,
			.Focus_Active = COLOR_GREY_850,
			.Disabled = COLOR_TRANSPARENT,
		},
		fg_color = {
			.Normal = COLOR_GREY_395,
			.Hover = COLOR_GREY_150,
			.Active = COLOR_GREY_150,
			.Engaged = COLOR_GREY_150,
			.Engaged_Hover = COLOR_GREY_150,
	...
	.Status_Error = {
		...
		bg_color = {
			...
			.Hover = COLOR_ERROR_700,
			.Active = COLOR_ERROR_700,
			.Engaged = COLOR_ERROR_700,
			.Engaged_Hover = COLOR_ERROR_700,
			.Engaged_Active = COLOR_ERROR_700,
			.Focus = COLOR_ERROR_700,
			.Focus_Hover = COLOR_ERROR_700,
			.Focus_Active = COLOR_ERROR_700,
			.Disabled = COLOR_TRANSPARENT,
		},
		fg_color = {
			.Normal = COLOR_ERROR_150,
			.Hover = COLOR_ERROR_100,
			.Active = COLOR_ERROR_100,
			.Engaged = COLOR_ERROR_100,
			.Engaged_Hover = COLOR_ERROR_100,
			.Engaged_Active = COLOR_ERROR_100,
			.Focus = COLOR_ERROR_100,
			.Focus_Hover = COLOR_ERROR_100,
			.Focus_Active = COLOR_ERROR_100,
			.Disabled = COLOR_GREY_605,
		},
		radius = {5, 5, 5, 5},
		child_align = {.Center, .Center},
